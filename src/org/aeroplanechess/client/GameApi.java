/*
 * Source: Prof. Zibin's GameApi.java
...
public final class GameApi {
  ...
  public static class UpdateUI extends HasEquality {
    ...
    public List<Object> getFieldsNameAndValue() {
      return Arrays.<Object> asList("yourPlayerId", yourPlayerId,
          "playersInfo", playersInfo, "state", state, "lastState", lastState,
          "lastMove", lastMove, "lastMovePlayerId", lastMovePlayerId);
    }
    ...
    public String getPlayerProfilePicUrl(int playerId) {
      return String
          .valueOf(getPlayerInfo(playerId).get(PLAYER_PROFILE_PIC_URL));
    }
  ...
  public static class VerifyMove extends UpdateUI {
    ...
    public VerifyMove(int yourPlayerId, List<Map<String, Object>> playersInfo,
        Map<String, Object> state, Map<String, Object> lastState,
        List<Operation> lastMove, int lastMovePlayerId) {
      super(yourPlayerId, playersInfo, state, lastState, lastMove,
          lastMovePlayerId);
    }
  ...
  public abstract static class HasEquality {
    ...
    public static HasEquality messageToHasEquality(Map<String, Object> message) {
      ...
      case "VerifyMove":
        return new VerifyMove((Integer) message.get("yourPlayerId"),
            (List<Map<String, Object>>) message.get("playersInfo"),
            (Map<String, Object>) message.get("state"),
            (Map<String, Object>) message.get("lastState"),
            messageToOperationList(message.get("lastMove")),
      ...
      case "EndGame":
        return new EndGame(
            (Map<String, Integer>) message.get("playerIdToScore"));

      case "Set":
        return new Set((String) message.get("key"), message.get("value"),
            message.get("visibleToPlayerIds"));

      case "SetRandomInteger":
        return new SetRandomInteger((String) message.get("key"),
            (Integer) message.get("from"), (Integer) message.get("to"));
      ...
      case "VerifyMoveDone":
        return new VerifyMoveDone((Integer) message.get("hackerPlayerId"),
